// Patched for the apriltag-projector Patchwork tool: load both dependencies
// from local vendored siblings instead of a CDN, so the worker has no external
// fetch. Originals were:
