  ...
  return (
    <div
      ...
      ondragover={(event: DragEvent) => {
        ...
        const overItem = (event.target as Element).closest(
          ".document-list-item",
        );
    ...
    >
      <Item
        ...
        parentFolderHandle={props.rootFolderHandle}
        itemIndex={0}
        isExpanded={expanded()}
      ...
      <div
        ...
        classList={{
          "document-list-folder__contents--hidden": !expanded() && !filter(),
        }}
        data-depth={depth()}
        style={depthStyle()}
      >
