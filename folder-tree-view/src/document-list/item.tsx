...
import { useSupportedToolsForType } from "../lib/solid-plugins.ts";
import type { PatchworkViewElement } from "@inkandswitch/patchwork-elements";
import {
  type TreeDragAndDropItem,
  dragstack,
  addToDragstack,
  removeFromDragstack,
  clearDragstack,
      ...
      <ContextMenu.Trigger
        ...
        ondragstart={(event: DragEvent) => {
          ...
          preview.style.cssText = `
            position: absolute;
            top: -1000px;
            background: var(--folder-tree-primary);
            padding: 0.5rem 0.75rem;
            border-radius: var(--folder-tree-radius);
            font-family: inherit;
            font-size: 0.9rem;
            pointer-events: none;
            color: var(--folder-tree-line);
