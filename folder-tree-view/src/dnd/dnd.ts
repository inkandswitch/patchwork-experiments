...
export type TreeDragAndDropItem = {
  id: string;
  url: AutomergeUrl;
  type: string;
  name: string;
...
export const dragstack = new Map<string, TreeDragAndDropItem>();
...
export function addToDragstack(id: string, item: TreeDragAndDropItem) {
