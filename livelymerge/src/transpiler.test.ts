...
describe('transpile', () => {
  ...
  $scope2.x = 0;
  $scope2.y = 1;
  return $func(($scope2) => (a) => $scope2.x * $scope2.y, [$scope2]);
}`);
    });
  ...
  $scope2.x = 0;
  let y = 1;
  return $func(($scope2) => (a) => $scope2.x * $scope2.x, [$scope2]);
}`);
    });
  ...
  $scope2.y = 1;
  return $arr([
    $func(($scope2) => () => $scope2.x * $scope2.x, [$scope2]),
    $func(($scope2) => () => $scope2.y * $scope2.y, [$scope2])
  ]);
}`);
    });
  ...
  const $scope3 = $obj({});
    $scope3.y = 1;
    return $func(($scope2, $scope3) => (a) => $scope2.x * $scope3.y, [$scope2, $scope3]);
  }
}`);
    });
