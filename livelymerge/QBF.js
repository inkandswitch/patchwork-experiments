...
//
// Load QBFWordList.js first (compact/expand/lookup helpers), then this file the
// way newdefs.js is loaded -- evaluate both in a LivelyMerge workspace -- then
// runQBF() to put a game in the world. Use "show scores" on the board for the
// scores viewer. Sounds and the high-scores viewer/store are included here.
// This file keeps qbfEmbeddedWordList() (the huge compact string) plus
// qbfEnsureWordList(); use QBFWordList.js to regenerate or add words.
//
...
// Word list: see QBFWordList.js ($qbfWordList, compact/expand/add). This file only
// embeds the compact string (qbfEmbeddedWordList) and reinstalls it via qbfEnsureWordList.
...
function qbfEnsureWordList() {
   ...
   * Requires QBFWordList.js ($qbfWordList / qbfSetWordList). The compact string
   * lives in qbfEmbeddedWordList below so word checking survives reloads.
...
class QBFMorph extends Morph {
  constructor() {
    ...
    this.playerName = qbfDefaultPlayerName();
  ...
  blankScoreReadouts(blank) {
    /**
     * Idle mode: hide the four score boxes, captions, and best-word label completely
     * (zero bounds → only the brown board shows). Soft-idle after a finished game
     * leaves scores visible (does not call this).
     */
    let boxes = [
      this.letterScoreBox,
      this.wordScoreBox,
  ...
  toggleAutoPlay() {
    /**
     * Toggle hands-free Otto play (5-letter then 4). When on, the player name
     * becomes "Otto" for scoring; turning off restores the prior name.
     */
    this.autoPlay = !this.autoPlay;
    if (!this.autoPlay) {
      this.cancelAutoPlayTyping();
      if (this.$nameBeforeOtto != null) {
        this.playerName = this.$nameBeforeOtto;
...
function qbfEmbeddedWordList() {
  ...
  return '';
}
qbfEnsureWordList();
