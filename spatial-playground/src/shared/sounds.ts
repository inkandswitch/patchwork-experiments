...
import { createNoiseSource } from './audio.ts';

export function createLayerGain(context: AudioContext, peakGain: number) {
...
export function startSoundPreset(context: AudioContext, presetId: SoundId): () => void {
  if (presetId === 'chime') {
