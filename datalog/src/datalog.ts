...
export function serializeFact(f: StoredFact): string {
...
export function serializeRule(r: StoredRule): string {
...
export function serializeConstraint(c: StoredConstraint): string {
