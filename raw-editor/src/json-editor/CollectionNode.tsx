...
export const CollectionNode: React.FC<CollectionNodeProps> = (props) => {
  ...
  useEffect(() => {
    if (collapseState !== null) {
      ...
      if (matchingCollapse) {
        setCollapsed(matchingCollapse.collapsed)
      }
    }
    // eslint-disable-next-line
  }, [collapseState])
  ...
  if (childrenEditing && collapsed) setCollapsed(false)
  ...
  const CollectionChildren = collapsed ? null : !isEditing ? (
  ...
  const CollectionNodeComponent = (
    ...
    >
      ...
      <div
        ...
        style={{
          overflowY: isCollapsed ? 'clip' : 'visible',
