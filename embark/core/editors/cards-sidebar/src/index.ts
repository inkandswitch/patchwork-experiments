...
export const plugins: Plugin<any>[] = [
  {
    ...
    icon: "Layers",
    async load() {
      const { CardsSidebarComponent } = await import("./host");
  ...
  },
  {
    ...
    unlisted: true,
    async load() {
      const { CardsKeeperTool } = await import("./host");
  ...
  },
  {
    ...
    unlisted: true,
    async load() {
      const { CardStackDatatype } = await import("./datatype");
  ...
  },
  {
    ...
    async load() {
      const { CardStackTool } = await import("./CardStackTool");
