...
const SKILLS: Skill[] = [
  {
    ...
    description:
      "The shared context store: discovery, owners, scoped slices, subscribe/read/release, merge rules, and the full channel roster. Read this for ANY card that talks to the canvas (almost all do).",
