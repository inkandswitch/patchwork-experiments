...
import { SearchQueries } from "@embark/search";
...
// the embed reads). `search:results` and `stickers` have dedicated views
// (SearchResultsTable / StickersView), so they aren't handled here.
export function ChannelValue(props: {
  ...
  return (
    ...
    >
      ...
      <Match
        when={
          props.channel === Selection.name || props.channel === Highlight.name
        }
      >
        <Tokens
