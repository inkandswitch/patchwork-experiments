...
// (Replaces the former `repoFromView` from the embed lib.)
function repoFromEditor(view: EditorView): Repo | undefined {
  const host = view.dom.closest("patchwork-view") as
    | (HTMLElement & { repo?: Repo })
    | null;
  return host?.repo;
}
