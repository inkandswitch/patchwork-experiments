...
// `element`. It shares no scanning code with the Convert-to-imperial card.
export const ConvertToMetricTool: ToolRender = (_handle, element) =>
...
function UnitConverterCard(props: { element: ToolElement }) {
  onMount(() => {
