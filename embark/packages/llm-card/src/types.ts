...
import type { findContextStore } from "@embark/core";

// The folder/file-link shapes live in @embark/core (shared with inspect and the
// card providers); re-export them so this package's folder helpers keep their
// local `./types` import surface.
export type { FolderDoc, DocLink } from "@embark/core";
