...
export const DEFAULT_FACTS = parseProgram(DEFAULT_FACTS_TEXT).facts;
export const DEFAULT_RULES = parseProgram(DEFAULT_RULES_TEXT).rules;
export const DEFAULT_CONSTRAINTS = parseProgram(DEFAULT_CONSTRAINTS_TEXT).constraints;
export const DEFAULT_PROGRAM_TEXT =
