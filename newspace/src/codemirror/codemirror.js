...
import { indentUnit, foldGutter, foldKeymap, bracketMatching, indentOnInput, syntaxHighlighting, defaultHighlightStyle } from "@codemirror/language";
  ...
  constructor(opts = {}) {
    ...
    this.view = new EditorView({
      ...
      extensions: [
        ...
        // colour the syntax (the big missing piece — language parser tags → colours,
        // like ../file). `fallback` styles even unparsed text sensibly.
