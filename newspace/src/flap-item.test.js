// FLAPS as ITEMS — a `flap: true` FRAME (TODO.md's confirmed design): a named
...
// (The dormant registry-flap chrome in flaps.jsx is a different, unshipped
// design — these are canvas items.)
import { describe, it, expect, afterEach } from "vitest";
import { render } from "solid-js/web";
import { Repo } from "@automerge/automerge-repo";
import { registerPlugins } from "@inkandswitch/patchwork-plugins";
import { Canvas } from "./brush/canvas.jsx";
import { makeFlapSpace, partsWindowSeedItem } from "./brush/constants.js";
