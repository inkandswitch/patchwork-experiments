...
export const useDatatypeDescriptions = () =>
  usePluginDescriptions<DatatypeDescription, DatatypeImplementation>('patchwork:datatype');

export const useDatatype = (id?: string) =>
  usePlugin<DatatypeDescription, DatatypeImplementation>('patchwork:datatype', id);

export const useToolDescriptions = () =>
  usePluginDescriptions<ToolDescription, ToolImplementation>('patchwork:tool');

export const useTool = (id?: string) =>
  usePlugin<ToolDescription, ToolImplementation>('patchwork:tool', id);
